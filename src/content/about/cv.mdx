...
Hi, I'm Jordan - a Smart Contract Engineer from the UK primarily focused on building DeFi applications
in the Ethereum ecosystem. I currently lead the Solutions Engineering team at [Aragon](https://aragon.org).
...
[telegram](https://t.me/jordaniza).

# Latest Experience
<JobHeader title="Head of Solutions" date="2025 - Present" org="Aragon" />
<SkillsList skills={["solidity", "hardhat", "foundry", "typescript"]} />

- Lead Solutions Engineering at Aragon, turning client requirements into protocol architecture, implementation scopes, and custom governance solutions.
- Partner with business development on technical sales, scoping, pricing, and delivery planning, then manage execution with the engineering team.
- Supported high-value paid client engagements such as Polygon, Morpho, Spark, CoW Swap, YieldBasis, Katana, Boundless, Steakhouse, Status, and Benqi, contributing to Aragon’s move from loss-making toward breakeven.

<JobHeader title="Senior Smart Contract Engineer" date="2024 - 2025" org="Aragon" />
<SkillsList skills={["solidity", "hardhat", "foundry", "typescript", "The Graph", ]} />

- Senior engineer primarily responsible for [ve-governance](https://github.com/aragon/ve-governance) builds as part of Aragon's custom development team.
- Led the ideation, architecture and development of the new governance system, [based on best in class designs](https://github.com/jordaniza/ve-explainer/blob/main/README.md) from projects like Curve, Aura, Aerodrome, Solidly and others. 
- Within first 3 months, we brought on over $30m of TVL across major projects like [Mode](https://gov.mode.network) and [Puffer](https://vote.puffer.fi).
- Also developed [Toucan Voting](https://github.com/aragon/toucan-voting-plugin), a multichain voting system that supports paymaster integration for gasless onchain governance.
...
- Wrote the
  ...
  staked governance participants:
...
- Distributed over 1m BANK in bounties through the board over the period, a 10x
...
- Previously graduate analyst, worked as part of THG's product team to provide analytics for supply chain development initiatives.
- Moved into M&A role where my role was to assist integration of newly acquired businesses purchased by THG Brands. 

# Other Work & Research

- CoW Swap Value Accrual: [RFP for the CoW DAO to study tokenomics of the COW token](https://forum.cow.fi/t/rfp-cow-value-distribution-mechanism/3328/16), including a comparative benchmark analysis
  of major DeFi protocols, and Monte-Carlo financial forecasting to project cashflow outcomes with different value accrual strategies.
