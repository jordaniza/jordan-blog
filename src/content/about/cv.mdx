...
in the Ethereum ecosystem. I'm currently helping onchain organizations build on top of [Aragon OSx](https://aragon.org/aragonosx).
...
- Lead the ideation, architecture and development of the new governance system, [based on best in class designs](https://github.com/jordaniza/ve-explainer/blob/main/README.md) from projects like Curve, Aura, Aerodrome, Solidly and others. 
