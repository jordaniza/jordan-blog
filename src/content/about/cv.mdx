...
in the Ethereum ecosystem. My latest work was at AuxoDAO where I worked as the
smart contract development lead for the protocol. Before that, I worked as a
full stack Web3 engineer primarily in Solidity and Typescript. Before moving to
DeFi, I had several years experience as a Web Developer and backend engineer.

I'm passionate about the potential of Web3 to offer a meaningful alternative to
the current financial system. I'm currently researching some of the new
frontiers in the Web3 space, in particular using Account Abstraction, Zk Proofs
and Alt-L1s to unlock new use-cases in crypto and DeFi. You can find my
technical writing on [this website](/learn-assembly-by-hacking).
