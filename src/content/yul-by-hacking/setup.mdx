---
title: Setup
description: Covering the basics of setting up our repo and development enviornment
index: 1
prev: intro
next: fallback
---
...
// something about what we are going to do
...
Assuming you ARE seeing the above, then we can get started on our [first exploit](/yul-by-hacking/fallback)
